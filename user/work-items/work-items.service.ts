...
export class WorkItemsService {
  ...
  getItems(): Observable<WorkItems[]> {
    return this.http.get<WorkItems[]>('http://localhost:7777/ftr/workItems').pipe(
  ...
  addItems(items: WorkItems): Observable<any> {
    ...
    return this.http.post('http://localhost:7777/ftr/workItems/addItem', items, { headers: options }).pipe(
      catchError(this.handleError));
  }
